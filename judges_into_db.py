...
c = db.cursor()
rownum = 1
print   """ INSERT INTO `ITC`.`IP_cases_district_courts_and_judges` (`id`, `judge_first_name`, `judge_middle_name`, `judge_last_name`, `birth_year`, `court_name`, `president_name`, `part_affliation_of_president`, `ABA_rating`, `senate_vote_date`, `commission_date`, `retirement`, `termination_date`) VALUES (%d,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s) """ %(rownum,sheet.row_values(rownum)[0],sheet.row_values(rownum)[1],sheet.row_values(rownum)[2],sheet.row_values(rownum)[3],sheet.row_values(rownum)[4],sheet.row_values(rownum)[5],sheet.row_values(rownum)[6],sheet.row_values(rownum)[7],sheet.row_values(rownum)[8],sheet.row_values(rownum)[9],sheet.row_values(rownum)[10],sheet.row_values(rownum)[11])
