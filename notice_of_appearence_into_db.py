...
for rownum in range(25,sheet.nrows):
    print rownum              
    c.execute(""" INSERT INTO `ITC`.`IP_cases_notice_of_appearence` (`id`, `doc_id`, `invoice_number`, `sec`, `F`, `offcial_recieve`, `firm__or_organisation`, `filled_on_behalf`, `office`, `state`, `attorney_first_name`, `attorney_last_name`, `notes`) VALUES 
